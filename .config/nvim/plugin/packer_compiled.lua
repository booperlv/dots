...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-colorizer.lua', 'emmet-vim', 'gitsigns.nvim', 'indent-blankline.nvim', 'vim-surround', 'vim-wordmotion'}, { event = "BufRead *" }, _G.packer_plugins)]]
