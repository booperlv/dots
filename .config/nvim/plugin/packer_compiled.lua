...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'Comment.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'emmet-vim', 'gitsigns.nvim', 'vim-wordmotion'}, { event = "BufRead *" }, _G.packer_plugins)]]
