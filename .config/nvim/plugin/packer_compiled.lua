...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'vim-surround', 'Comment.nvim', 'vim-wordmotion', 'nvim-colorizer.lua', 'emmet-vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
