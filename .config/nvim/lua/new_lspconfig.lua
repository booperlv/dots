...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', '<leader>lsD', '<cmd>lua vim.lsp.buf.type_definition()<CR>', opts)
  ...
  buf_set_keymap('n', '<leader>lsgr', '<cmd>lua vim.lsp.buf.references()<CR>', opts)
...
local servers = { "tsserver", "html", "cssls", "vimls", "bashls", "jedi_language_server", "clangd", "solargraph" }
